...
// Sourced from the shared research module so the nav, homepage, About page,
// footer and this page can never disagree about what has been published.
...
const featuredProject = {
  ...
  desc: "100+ neural agent orchestration pipeline: a multi-agent system that autonomously coordinates technical audits, content optimization, and competitive analysis at enterprise scale.",
...
const projects = [
  ...
  },
  {
    ...
    status: "Active",
    desc: "Retrieval-Augmented Generation engine for enterprise knowledge bases, with natural language querying across millions of documents.",
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20 px-6 relative overflow-hidden">
      <SEO
        ...
        description="Original AI research, production systems, published papers, and interactive explorations, built at the intersection of AI, business intelligence, and search."
                      ...
                      <div className="flex items-center gap-4 flex-wrap">
                        ...
                        {pub.link ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 font-mono text-xs text-foreground hover:text-glow transition-all"
                          >
                            Read on {pub.host} <ExternalLink size={12} />
                          </a>
                        ) : (
