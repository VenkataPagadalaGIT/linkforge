      ...
      {[
        ...
        <div
          ...
          style={{
            ...
            `,
            backgroundImage: `
              linear-gradient(hsl(var(--foreground) /${panel.opacity}) 1px, transparent 1px),
              linear-gradient(90deg, hsl(var(--foreground) /${panel.opacity}) 1px, transparent 1px)
            `,
            backgroundSize: "20px 20px",
            backgroundPosition: `${mouse.x * panel.depth * 5}px ${mouse.y * panel.depth * 5}px`,
            border: `1px solid hsl(var(--foreground) /${panel.opacity * 0.8})`,
          }}
        />
      ))}
