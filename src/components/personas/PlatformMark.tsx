    ...
    case "threads":
      return (
        <svg {...common}>
          <rect x="2" y="2" width="20" height="20" rx="5" fill="#000" />
          <path
            d="M12.4 19c-2.3 0-4-.8-5-2.3-.9-1.3-1.3-3-1.3-4.7s.4-3.4 1.3-4.7c1-1.5 2.7-2.3 5-2.3 1.6 0 2.9.4 3.9 1.1.9.7 1.5 1.6 1.8 2.8l-1.7.5c-.4-1.7-1.6-2.6-3.9-2.6-1.7 0-2.8.5-3.5 1.6-.6.9-.9 2.2-.9 3.6s.3 2.7.9 3.6c.7 1 1.8 1.6 3.5 1.6 1.5 0 2.6-.4 3.2-1.1.4-.5.6-1 .6-1.6 0-.9-.4-1.5-1.2-1.9-.3 1.6-1.2 2.9-3.1 2.9-1.6 0-2.8-1-2.8-2.5 0-1.7 1.5-2.6 3.6-2.6.6 0 1.2 0 1.7.1 0-1.1-.6-1.7-1.8-1.7-.8 0-1.4.3-1.8.9l-1.4-.9c.7-1 1.8-1.6 3.2-1.6 2.2 0 3.4 1.3 3.4 3.5v.4c1.4.7 2.1 1.9 2.1 3.4 0 1.1-.4 2.1-1.1 2.8-1 1.1-2.6 1.7-4.7 1.7zm-.1-6.1c-1.2 0-1.9.4-1.9 1.1 0 .6.5.9 1.2.9 1 0 1.5-.8 1.6-2-.3 0-.6 0-.9 0z"
            fill={c}
          />
        </svg>
      );
    case "bluesky":
      return (
        <svg {...common}>
          ...
          <path
            d="M12 11.2C10.9 9.1 8 5.5 6.1 5.5c-1.2 0-1.6 1-1.6 2.4 0 1.3.5 4.4.8 5 .5 1 1.5 1.3 2.6 1.2.2 0 .3 0 .1.1-1.6.2-3 .8-1.2 2.8 2 2.2 2.8-.5 3.2-1.9.1-.4.2-.6.2-.4 0-.2.1 0 .2.4.4 1.4 1.2 4.1 3.2 1.9 1.8-2 .4-2.6-1.2-2.8-.2 0-.1-.1.1-.1 1.1.1 2.1-.2 2.6-1.2.3-.6.8-3.7.8-5 0-1.4-.4-2.4-1.6-2.4-1.9 0-4.8 3.6-5.9 5.7z"
            fill={c}
          />
        </svg>
      );
    case "truthsocial":
      return (
        <svg {...common}>
          ...
          <path d="M6.5 6.2h11v2.9h-4v8.7h-3V9.1h-4z" fill="#fff" />
        </svg>
      );
    default:
